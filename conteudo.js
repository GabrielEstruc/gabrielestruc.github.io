...
function abrirPrototipoMonkey(){
  document.getElementById("prototipoMonkey").style = "display: block";
  document.getElementById("tela").style = "display: none";
}
function abrirPrototipoSnack(){
  document.getElementById("prototipoSnack").style = "display: block";
